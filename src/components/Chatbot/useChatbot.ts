...
import type { Message } from '@site/src/types';
...
export default function useChatbot(): UseChatbotReturn {
	const { siteConfig } = useDocusaurusContext();
	const apiKey = (siteConfig.customFields?.APARAVI_API_KEY as string) || '';
